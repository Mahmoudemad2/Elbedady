    ...
    },
{
...

    {
      ...
      year: "القرن  الواحد و العشرين",
      description:
         " نرفع رؤوسنا عالياً بوجود رجل مثلكم في الأسرة البدادية ، يجمع بين الأصل العريق والسلوك المهذب , لقد زرع الأجداد فيكم القيم النبيلة ، فكنتم خير خلف لخير سلف ، سيرتكم العطرة تملأ القلوب فخراً , إن السيرة العطرة التي يتتمتع بها هي نتاج أصل طيب وتربية راقية ، نفخر بكم وبانتمائكم لهذه العائلة الكريمة , شيخ العرب على مفتاح هو حفيد  شيخ العرب  جبيل عبد السميع ابن ابراهيم بك عبد السميع شهيد معركة التل الكبير   ",
      image: ali,
    },
