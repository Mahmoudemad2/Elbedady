...
const FamilyStages = () => {
  const stages = [
    ...
    },
    {
      ...
      icon: Cloud,
      color: "text-blue-500",
      description: "هذه المرحلة تبدأ من شعيب الحميرى إلى رأس الأسرة الأولى عبد القادر البدادى. شعيب أول من عرفنا معرفة اليقين من أجدادنا الأول فهو جد عبد القادر البدادى المشهور ووالد محمد أب عبد القادر. إذن الجد الأول شعيب ثم محمد ثم عبد القادر البدادى.",
